...
mraa_radxa_rock_3b()
{
    ...
    mraa_radxa_rock_3b_pininfo(b, 3, 1, 0, (mraa_pincapabilities_t){1,1,0,0, 0,1,0,1}, "GPIO1_A0"); // can't control
    mraa_radxa_rock_3b_pininfo(b, 4, -1, -1, (mraa_pincapabilities_t){1,0,0,0,0,0,0,0}, "5V");
    mraa_radxa_rock_3b_pininfo(b, 5, 1, 1, (mraa_pincapabilities_t){1,1,0,0, 0,1,0,1}, "GPIO1_A1"); // can't control
    ...
    mraa_radxa_rock_3b_pininfo(b, 8, 0, 25, (mraa_pincapabilities_t){1,0,0,0, 0,0,0,1}, "GPIO0_D1"); // Used by fiq_debugger
    mraa_radxa_rock_3b_pininfo(b, 9, -1, -1, (mraa_pincapabilities_t){1,0,0,0, 0,0,0,0}, "GND");
    mraa_radxa_rock_3b_pininfo(b, 10, 0, 24, (mraa_pincapabilities_t){1,0,0,0, 0,0,0,1}, "GPIO0_D0"); // Used by fiq_debugger
    ...
    mraa_radxa_rock_3b_pininfo(b, 16, 0, 14, (mraa_pincapabilities_t){1,1,1,0, 0,1,0,0}, "GPIO0_B6");
