...
mraa_radxa_rock_3a()
{
    ...
    b->pins[17].pwm.parent_id = 2;  // PWM2_M0
    b->pins[17].pwm.mux_total = 0;
    ...
    b->pins[27].pwm.parent_id = 2; // PWM2_M1
    b->pins[27].pwm.mux_total = 0;
    b->pins[28].pwm.parent_id = 1; // PWM1_M1
    ...
    mraa_radxa_rock_3a_pininfo(b, 7, 3, 15, (mraa_pincapabilities_t){1,1,1,0,0,0,0,1}, "GPIO3_B7");
    ...
    mraa_radxa_rock_3a_pininfo(b, 16, 3, 1, (mraa_pincapabilities_t){1,1,0,0,0,0,0,0}, "GPIO3_A1");
    mraa_radxa_rock_3a_pininfo(b, 17, 0, 17, (mraa_pincapabilities_t){1,1,1,0,0,0,0,1}, "GPIO0_C1");
    ...
    mraa_radxa_rock_3a_pininfo(b, 22, -1, -1, (mraa_pincapabilities_t){1,0,0,0,0,0,1,0}, "ADC_IN5");
    ...
    mraa_radxa_rock_3a_pininfo(b, 27, 0, 14, (mraa_pincapabilities_t){1,1,1,0,0,1,0,0}, "GPIO0_B6");
    mraa_radxa_rock_3a_pininfo(b, 28, 0, 13, (mraa_pincapabilities_t){1,1,1,0,0,1,0,0}, "GPIO0_B5");
    ...
    mraa_radxa_rock_3a_pininfo(b, 33, 3, 19, (mraa_pincapabilities_t){1,1,0,0,0,0,0,1}, "GPIO3_C3");
    ...
    mraa_radxa_rock_3a_pininfo(b, 37, 3, 16, (mraa_pincapabilities_t){1,1,1,0,0,0,0,1}, "GPIO3_C0");
    ...
    mraa_radxa_rock_3a_pininfo(b, 40, 3, 5, (mraa_pincapabilities_t){1,0,0,0,0,0,0,0}, "GPIO3_A5");
